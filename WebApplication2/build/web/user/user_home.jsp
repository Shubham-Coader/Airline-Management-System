...
<%! String email,name, msg, user_mobile; int id; %>
<%
...
String sql="select user_name, user_id, user_mobile from user where user_email='"+email+"'";
ResultSet rs=stmt.executeQuery(sql); 
if(rs.next()){
name=rs.getString(1);
id= rs.getInt(2);
user_mobile = rs.getString(3);
}
                    ...
                    <% if(msg=="200")
                          {
                              ...
                              <div class="alert alert-success" role="alert">
                                Your Flight Ticket booking successful!!
                            </div>
                          <%
                          }
                          if(msg=="201"){
                            ...
                            <div class="card card_border py-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4 ">
                                            <a href="#url">
                                                <img class="img-fluid" style="border-radius: 50%; width:200px; height:200px" src="assets/images/profile/<%if(id==1){out.print(id);}else{out.print("2");}%>.jpg" alt=" ">
                                            </a>
                                        </div>
                                        <div class="col-sm-8 align-self mt-sm-0 mt-4">
                                            <h1><%=name%></h1>
                                            <p class="">Website User</p>
                                            <ul class="team-details">
                                                
                                                <li><a href="tel:<%=user_mobile%><"><span class="material-icons">call</span>
                                                        +(91)<%=user_mobile%></a></li>
                                                <li><a href="mailto:<%=email%>" class="mail"><span class="material-icons">email</span></span><%=email%></a>
                                                </li>
                                            </ul>
