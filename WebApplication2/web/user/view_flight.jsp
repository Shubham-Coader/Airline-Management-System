...
<head>
  ...
  <title>User Home: View Flight</title>
                                ...
                                <thead>
                                    ...
                                    <%
                                      ...
                                      if(request.getParameter("source")!=null && request.getParameter("destination")!=null && request.getParameter("departure")!=null)
                                      {
                                         ...
                                         view_sql = "SELECT flight_name, (SELECT coumpany_name FROM airline_company WHERE company_name=company_id) AS Company, no_of_seats,(SELECT city_name FROM city WHERE city_id=source),(SELECT city_name FROM city WHERE city_id=destination), price, dep_time, arr_time, flight_id, company_name, flight_status FROM flight  where source="+source+" and destination="+destination+" and date(dep_time)='"+departure+"' and flight_status=1";
                                      }
                                      else
                                      {
                                          view_sql = "SELECT flight_name, (SELECT coumpany_name FROM airline_company WHERE company_name=company_id) AS Company, no_of_seats,(SELECT city_name FROM city WHERE city_id=source),(SELECT city_name FROM city WHERE city_id=destination) , price, dep_time, arr_time, flight_id, company_name, flight_status FROM flight where flight_status=1 order by dep_time";
                                      }
                                      try{
                                          Class.forName("com.mysql.jdbc.Driver");
                                          ...
                                          while(rs1.next()){
                                              ...
                                              out.print("<tr><th scope=\"row\">"+rs1.getString(1)+"</th><td><img src=\"../images/airline/"+rs1.getInt(10)+".jpg\" style=\"width:40px; height:40px; border-radius:50%\"> &nbsp;&nbsp;&nbsp;"+rs1.getString(2)+"</td><td>"+rs1.getInt(3)+"</td><td>"+rs1.getString(4)+"</td><td>"+rs1.getString(5)+"</td><td>"+rs1.getString(7)+"</td><td>"+rs1.getString(8)+"</td><td>"+rs1.getInt(6)+"</td><td><a href=\"booking.jsp?id="+rs1.getInt(9)+"\" class=\"btn btn-success\">Book Now</a></td></tr>");
