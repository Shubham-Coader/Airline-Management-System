...
if(request.getParameter("old_password")!=null && request.getParameter("new_password")!=null && request.getParameter("con_password")!=null)
{
    ...
    update_sql = "update admin set admin_password='"+new_password+"' where admin_email='"+email+"' and admin_password='"+old+"'";
}
try{
...
<head>
  ...
  <title>Admin Home: Update Password</title>
                    ...
                    <div class="row px-2">
                        <div class="col-md-12 mb-4 px-2">
                          ...
                          %>
                            ...
                            <form class="update_password" action="admin_update_password.jsp" method="post">
